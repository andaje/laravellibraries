        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-arrow-circle-down"></i>Books<span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-arrow-circle-down"></i>Book Item<span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">

                            <li>
                                <a href="{{route('barcodes.index')}}">All BookItems</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-arrow-circle-down"></i>Rent<span
                                class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
